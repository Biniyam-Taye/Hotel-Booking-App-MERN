...
export const exclusiveOffers = [
    {
        ...
        longDescription: 'Escape the ordinary with our Summer Escape Package — designed for travelers who crave golden beaches, ocean breezes, and effortless luxury. Book a minimum three-night stay at participating coastal resorts and unlock a complimentary fourth night plus chef-crafted breakfast each morning. Whether you are planning a family vacation or a solo recharge, this package layers premium perks onto an already exceptional stay.',
        priceOff: 25,
        expiryDate: 'Aug 31',
        ...
        gallery: [
            ...
            'https://images.unsplash.com/photo-1473496166314-658d2dc54cfc?q=80&w=1200',
            'https://images.unsplash.com/photo-1519046904884-53103b34f206?q=80&w=1200',
        ],
        originalFrom: 320,
        discountedFrom: 240,
        ...
        maxGuests: 4,
        category: 'Seasonal',
        destinations: ['Maldives', 'Bali', 'Santorini', 'Miami Beach'],
        highlights: [
            { title: '4th Night Free', desc: 'Stay 3 nights, get the 4th complimentary at select beachfront hotels.' },
            { title: 'Daily Breakfast', desc: 'Full buffet or à la carte breakfast for all registered guests.' },
            { title: 'Late Checkout', desc: 'Enjoy until 2 PM on your departure day — subject to availability.' },
            { title: 'Resort Credit', desc: '$50 daily credit toward spa, dining, or activities.' },
        ],
        inclusions: [
    ...
    },
    {
        ...
        longDescription: 'Celebrate love with our Romantic Getaway — a curated couples experience at boutique and luxury properties worldwide. From candlelit dinners to side-by-side spa rituals, every detail is designed to deepen connection and relaxation. This package pairs beautifully with anniversary trips, honeymoons, or spontaneous weekend escapes.',
        priceOff: 20,
        expiryDate: 'Sep 20',
        ...
        gallery: [
            ...
            'https://images.unsplash.com/photo-1520250497591-112f2f40a3b4?q=80&w=1200',
        ...
        maxGuests: 2,
        category: 'Romance',
        destinations: ['Paris', 'Venice', 'Kyoto', 'Napa Valley'],
        highlights: [
            { title: 'Couples Spa', desc: '90-minute signature massage or facial for two at the hotel spa.' },
            { title: 'Private Dinner', desc: 'Reserved table with wine pairing at the property\'s signature restaurant.' },
            { title: 'Room Upgrade', desc: 'Complimentary upgrade to a suite when available at check-in.' },
            { title: 'Turndown Ritual', desc: 'Rose petals, chocolates, and aromatherapy each evening.' },
        ],
        inclusions: [
    ...
    },
    {
        ...
        tagline: 'Book early, travel grand — exclusive savings on world-class stays',
        description: 'Book 60 days in advance and save on your stay at any of our luxury properties worldwide.',
        longDescription: 'The Luxury Retreat offer rewards planners who book ahead. Reserve any five-star property in our global collection at least 60 days before arrival and receive up to 30% off the best available rate, plus VIP touches reserved for our most discerning guests. Ideal for milestone celebrations, executive travel, and extended stays at iconic addresses.',
        priceOff: 30,
        expiryDate: 'Sep 25',
        ...
        maxGuests: 6,
        category: 'Luxury',
        destinations: ['Dubai', 'Singapore', 'London', 'New York', 'Tokyo'],
        highlights: [
            { title: '30% Early-Bird', desc: 'Substantial savings when you book 60+ days in advance.' },
            { title: 'VIP Airport Transfer', desc: 'Private sedan or SUV from airport to hotel, one way included.' },
            { title: 'Executive Lounge', desc: 'Complimentary lounge access for the duration of your stay.' },
            { title: 'Personal Concierge', desc: 'Dedicated concierge for itineraries, reservations, and requests.' },
        ],
        inclusions: [
