...
export const protect = async (req, res, next) => {
    try {
        ...
        console.error("Auth Middleware Error (Clerk API/Mongoose):", error.message);
        res.status(500).json({ success: false, message: "Authentication failed due to API or database error." });
    }
};
